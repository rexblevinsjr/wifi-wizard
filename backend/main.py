...
# File where agent submissions will be stored
...
# ============================================================
# NEW: Probe/Agent Submission Endpoint
# ============================================================
...
async def agent_submit(sample: AgentSample):
    ...
    The agent sends:
      - agent_id: unique ID for the device
      - timestamp: optional epoch seconds (float). If missing, backend fills it.
      - metrics: dict with ping, jitter, RSSI, etc.

    Each record is appended as JSONL in agent_history.jsonl
    for later charting and analysis.
    """
